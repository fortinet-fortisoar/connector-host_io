## About the connector
Get comprehensive domain name data, uncover new domains and the relationships between them. Also get DNS details, scraped website content, outbound links, backlinks, and other hosting details for any domain.
...
<table border=1><thead><tr><th>Function<br></th><th>Description<br></th><th>Annotation and Category<br></th></tr></thead><tbody><tr><td>Web Domain<br></td><td>Metadata scraped from a domain homepage.<br></td><td>web_domain <br/>Investigation<br></td></tr>
<tr><td>DNS Domain<br></td><td>Get all the DNS records stored for a domain.<br></td><td>dns_domain <br/>Investigation<br></td></tr>
<tr><td>Related Domain<br></td><td>Get a count of the number of related domains for all supported lookups offered by host.io.<br></td><td>related_domain <br/>Investigation<br></td></tr>
<tr><td>Full Domains<br></td><td>A single endpoint that includes the data from WEB DOMAIN, DNS DOMAIN, RELATED DOMAIN and IPinfo.<br></td><td>get_full_domains_data <br/>Investigation<br></td></tr>
...
#### Input parameters
<table border=1><thead><tr><th>Parameter<br></th><th>Description<br></th></tr></thead><tbody><tr><td>Endpoint URL<br></td><td>Endpoint URL name for which you want to retrieve a host.io list of domains.<br>
</td></tr></tbody></table>
